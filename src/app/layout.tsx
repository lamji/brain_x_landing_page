...
export const metadata: Metadata = {
  title: "BrainX - Autonomous AI Agent Platform",
  description: "The autonomous AI agent that thinks, learns, and executes with precision. Zero hallucination guarantee with locked execution model, MCP protocol integration, and regression-proof development.",
  icons: {
    icon: [
